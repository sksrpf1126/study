...
그래서 위처럼 Person 클래스에 오버라이딩하고 나서, 호출하고 나면 결과가 [abc, 홍길동:10] 로 서로다른 인스턴스여도 값의 중복을 체크하여 중복을 허용하지 않는다.  
  ...
  <p align = "center">
  <img src="https://github.com/sksrpf1126/study/assets/62879192/f06e012a-0013-4acb-9c09-fbece054d39c" width = 80%>
  </p>

정확한 동작방식은 위와 같이 hashCode 메서드의 리턴값이 다르다면 다른 객체로 판단하고, 같다면 equals 메서드를 호출하게 된다. 이후 equals 메서드의 리턴값이 false라면 다른 객체로, true라면 같은 객체로 판단한다.
